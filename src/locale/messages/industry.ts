...
export const industryMessages: LocaleData = {
  ...
  [IndustryMessageKey.INDUSTRY_LEGAL_AFFAIRS]: { ko: '법무·사무·총무', en: 'Legal·Admin' },
  ...
  [IndustryMessageKey.INDUSTRY_CS]: { ko: '고객상담·TM', en: 'Customer Service' },
  [IndustryMessageKey.INDUSTRY_FINANCE]: { ko: '금융·보험', en: 'Finance·Insurance' },
  [IndustryMessageKey.INDUSTRY_FOOD_BEVERAGE]: { ko: '식·음료', en: 'Food·Beverage' },
