          ...
          <div className="rounded-lg border border-neutral-200 bg-neutral-50">
            ...
            {openIndex === index && (
              <div className="px-5 pb-6">
                <p className="mb-6 text-base text-neutral-600">{weekData.description}</p>

                {/* 학습 주제 목록 */}
                <div className="space-y-4">
                  {weekData.learningTopics.map((topic, topicIndex) => (
                    <div key={topicIndex} className="flex items-start gap-x-3">
                      <CheckCircleIcon className="mt-1.5 h-5 w-5 flex-shrink-0 text-neutral-400" />
                      <div>
                ...
                {weekData.weeklyTask && (
                  <div className="mt-8 rounded-md border border-neutral-200 bg-neutral-50 p-4">
                    ...
                    <p className="mt-2 text-sm text-neutral-600">{weekData.weeklyTask}</p>
                  </div>
                )}
              </div>
            )}
