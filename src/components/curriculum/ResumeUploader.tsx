...
export default function ResumeUploader({ uploadedFiles, onAddFiles, onRemoveFile }: ResumeUploaderProps) {
    ...
    <>
      ...
      >
        ...
        <label htmlFor="file-input" className="cursor-pointer">
          <CloudUpload className="mx-auto w-10 h-10 text-neutral-400 mb-4"/>
          <p className="text-neutral-600 mb-2">
            <LocaleText keyOrLocaleData={MessageKey.GENERATE_FILE_DROPZONE_TEXT_1}/>
          </p>
          <span className="bg-neutral-800 text-white font-semibold py-2 px-5 rounded-lg inline-block hover:bg-neutral-700 transition-colors">
          ...
          <div className="mt-6 space-y-4">
            {uploadedFiles.map((file, index) => (
              <div
                ...
                className="bg-neutral-100 p-3 rounded-lg flex items-center justify-between text-left"
              >
                <div className="flex items-center overflow-hidden min-w-0">
                  <FileText className="h-5 w-5 text-neutral-600 mr-3 flex-shrink-0" />
                ...
                <button
                  ...
                  className="text-neutral-500 hover:text-red-500 transition-colors ml-4"
      ...
      <div className="mt-4 text-center text-sm text-neutral-500 space-y-1">
        <p><LocaleText keyOrLocaleData={MessageKey.GENERATE_FILE_HELPER_TEXT_1} /></p>
        <p><LocaleText keyOrLocaleData={MessageKey.GENERATE_FILE_HELPER_TEXT_2} /></p>
