      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-neutral-200 bg-white p-4">
            ...
            <blockquote className="mt-3 border-l-2 border-neutral-300 pl-3 text-sm text-neutral-600 break-keep">
              <p><LocaleText keyOrLocaleData={MessageKey.FEEDBACK_GUIDE_BUG_REPORT_EXAMPLE_1}/></p>
              <p><LocaleText keyOrLocaleData={MessageKey.FEEDBACK_GUIDE_BUG_REPORT_EXAMPLE_2}/></p>
            </blockquote>
          </div>
