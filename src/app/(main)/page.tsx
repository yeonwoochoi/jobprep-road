  ...
  return (
    <Container className="mt-0 sm:mt-8 md:mt-32">
      <FadeIn className="max-w-3xl">
        ...
        <p className="mt-6 text-xl text-pretty text-neutral-600">
          <LocaleText keyOrLocaleData={MessageKey.HOME_DESCRIPTION} />
        </p>
        <Button href="/curriculum" className="mt-6 h-12 w-[150px] text-lg">
    ...
    <div className="mt-32 py-32 lg:mt-56">
      ...
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 break-keep lg:mt-0 lg:w-1/2 lg:min-w-132 lg:pl-4">
...
function WhyUsCard({ icon: iconSrc, title, description }: WhyUsDistinction) {
  ...
  return (
    <FadeIn key={id} className="flex">
      <article className="w-full rounded-3xl p-6 ring-1 ring-neutral-950/5 hover:bg-neutral-50 sm:p-8">
        {iconSrc && (
          <Image
            src={iconSrc}
            alt={`why-us-icon-${id}`}
        ...
        <p
          id={titleId}
          className="font-display mt-6 text-2xl font-semibold break-keep text-neutral-950"
        >
          {title}
        </p>
        <p id={descriptionId} className="mt-4 text-base break-keep text-neutral-600">
          {description}
        </p>
      </article>
    </FadeIn>
